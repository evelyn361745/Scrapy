...
count = 0
class Culture01Spider(scrapy.spiders.Spider):
    name = "culture01"
    start_urls = ["http://channel.chinanews.com/cns/cl/cul-jd.shtml?pager=0", ]
    for i in range(1, 95):
    ...
    def parse_content(self, response):
        ...
        #//*[@id="cont_1_1_2"]/div[7]/p[1]/text()//*[@id="cont_1_1_2"]/div[7]/p[8]//*[@id="cont_1_1_2"]/div[5]/p[3]//*[@id="cont_1_1_2"]/div[5]/p[6]
