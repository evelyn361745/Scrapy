...
class Sports4Spider(scrapy.spiders.Spider):
    name = "sports_04"
    ...
    for i in range(2,1000):
        url = start_urls[0][:57]+ str(i)+".shtml"
...
#        start_urls.append(url)
    ...
    def parse(self, response):
        ...
        links = selector.xpath('//*[@id="wrap"]/div/ul/li/a/@href').extract()
        print links 
        titles = selector.xpath('//*[@id="wrap"]/div/ul/li/a/text()').extract()
